...
class AuthRepoImpl implements AuthRepo {
  ...
  @override
  Future<dartz.Either<Failure, SignInResultModel>> signIn(
    ...
    if (params.email.isNotEmpty && params.password.isNotEmpty) {
      result = await repoHandleRemoteRequest<SignInResultModel>(
        ...
        trySaveResult: (result) async {
          await authLocalDataSource.saveSignInResult(result);
  ...
  Future<void> _getCreateSaveSettings(
      {required String? userId, required AccessToken? accessToken}) async {
  ...
  @override
  Future<dartz.Either<Failure, SignUpResultModel>> signUp(
    ...
    await _getCreateSaveSettings(
        userId: result.getOrNull?.id, accessToken: params.accessToken);
    return result;
  }
  ...
  Future<dartz.Either<Failure, SignUpAnonymouslyResult>> signUpAnonymously(
    ...
    await _getCreateSaveSettings(
        userId: result.getOrNull?.user?.id, accessToken: result.getOrNull?.accessToken);
    return result;
  }
